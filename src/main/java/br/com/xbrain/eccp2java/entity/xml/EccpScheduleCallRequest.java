...
public class EccpScheduleCallRequest implements IEccpRequest {
    ...
    public static EccpScheduleCallRequest create(Long id, String agentNumber, String agentHash, Date dateInit, Date dateEnd, 
            Date timeInit, Date timeEnd, Integer sameagent, String newphone, String newcontactname) {
    ...
    private EccpScheduleCallRequest(Long id, String agentNumber, String agentHash, Date dateInit, Date dateEnd, Date timeInit, Date timeEnd, Integer sameagent, String newphone, String newcontactname) {
        this.id = id;
